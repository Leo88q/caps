...
| 27 | Путь выдачи квест-бустера и квест-фишки (`grant_booster` от `["rewarder"]` PDA; chip-ваучеры через VRF-пайплайн паков) | `programs/staking`, `programs/chip_core`, `backend/src/reward-oracle.ts`, клиент | см. ниже / G-1 |
