...
Итого до G-2 ≈ 15–17 инженерных дней (без аудита и soak-периода); #18 добавляет ≈ 1 день на oracle-джоб; #3 (части 1–2), #20–21 закрыты в этой сессии, #22 — 0.5 д, #23 — 0.5 д.
