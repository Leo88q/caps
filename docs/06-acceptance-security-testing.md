...
Итого до G-2 ≈ 9–11 инженерных дней (без аудита и soak-периода); #18 добавляет ≈ 1 день на SKR oracle-джоб; #3 (части 1–2), #14, #20–21, #24 закрыты в этой сессии (для #14 остаётся первый реальный прогон после `anchor build`), #22 — 0.5 д, #23 — 0.5 д.
