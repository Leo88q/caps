...
- Quest **chips** (`rewardChip`) are not covered: a chip is a Core asset minted through the VRF pack flow, so a voucher needs a `paid_* = 0` path through `buy_pack`/`open_pack` (backlog #28).
