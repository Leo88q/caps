...
> **Навигация.** Актуальная спецификация проекта живёт в `docs/00…07` (PRD, экономика,
> архитектура, бэкенд, фронтенд, приёмка/безопасность, арт-спецификация фишек), код программ — в `programs/`
