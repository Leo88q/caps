...
exports.PASS_TRACK = exports.PASS_XP = exports.EMOTE_PACK_OF = exports.EMOTE_PACK_BY_ID = exports.EMOTE_PACKS = exports.PROFILE_THEME_BY_ID = exports.PROFILE_THEMES = exports.SKIN_BY_ID = exports.SKINS = void 0;
exports.passTierForXp = passTierForXp;
...
exports.SKIN_BY_ID = Object.fromEntries(exports.SKINS.map((s) => [s.id, s]));
/** Profile lamp themes — recolor the profile showcase and the arena intro banner. */
exports.PROFILE_THEMES = [
...
exports.PROFILE_THEME_BY_ID = Object.fromEntries(exports.PROFILE_THEMES.map((t) => [t.id, t]));
...
exports.EMOTE_PACK_BY_ID = Object.fromEntries(exports.EMOTE_PACKS.map((p) => [p.id, p]));
/** emoteId → owning pack id (for validation: a tag is usable only from an owned pack). */
exports.EMOTE_PACK_OF = Object.fromEntries(exports.EMOTE_PACKS.flatMap((p) => p.emotes.map((e) => [e.id, p.id])));
/** Season-pass XP awards. Ranked play moves the track; nothing is bought. */
exports.PASS_XP = { matchWin: 100, matchLoss: 40, packOpen: 20 };
/**
...
function passTierForXp(xp) {
    let tier = 0;
    for (const t of exports.PASS_TRACK)
        if (xp >= t.xp)
            tier = t.tier;
    return tier;
}
