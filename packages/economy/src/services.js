...
exports.SERVICES_DAILY_CAP_RUST = exports.servicePriceCgMicro = exports.SERVICE_BY_KIND = exports.SERVICE_BY_ID = exports.SERVICES = exports.CG_MICRO_PER_CENT = void 0;
exports.servicesMonthlyRevenueUsd = servicesMonthlyRevenueUsd;
exports.CG_MICRO_PER_CENT = 1_000_000;
exports.SERVICES = [
...
exports.SERVICE_BY_ID = Object.fromEntries(exports.SERVICES.map((s) => [s.id, s]));
exports.SERVICE_BY_KIND = Object.fromEntries(exports.SERVICES.map((s) => [s.kind, s]));
const servicePriceCgMicro = (s) => s.priceUsdCents * exports.CG_MICRO_PER_CENT;
exports.servicePriceCgMicro = servicePriceCgMicro;
/** Textual form of the Rust `daily_cap` match arm — checked by sync-check.ts. */
exports.SERVICES_DAILY_CAP_RUST = 'Self::Booster => 3, Self::Handle | Self::HandleChange => 1, _ => 10';
/**
 * Revenue projection for services (monthly, USD) — used by docs/05 and the
 * admin dashboard "what-if" panel.
 */
function servicesMonthlyRevenueUsd(mau, conversion = 0.04, avgBasketUsd = 3.2, passShare = 0.08) {
