...
exports.COLLECTIONS = exports.RARITY_ORDER = void 0;
exports.findCollectionBySymbol = findCollectionBySymbol;
exports.chipNameFor = chipNameFor;
...
function findCollectionBySymbol(symbol) {
    return exports.COLLECTIONS.find((c) => c.symbol === symbol);
}
...
function chipNameFor(symbol, rarity) {
    const collection = findCollectionBySymbol(symbol);
    const tierIndex = exports.RARITY_ORDER.indexOf(rarity);
    if (!collection || tierIndex === -1)
        return 'Unknown Cap';
