...
exports.ANTI_FARM = exports.STAKING_JACKPOT = exports.REFERRAL = exports.PERMANENT_QUESTS = exports.WEEKLY_QUESTS = exports.DAILY_QUESTS = exports.QUEST_CHIP_TEMPLATES = void 0;
exports.freeValueReport = freeValueReport;
const rarity_ts_1 = require("./rarity.ts");
exports.QUEST_CHIP_TEMPLATES = [
...
const voucher = (template) => exports.QUEST_CHIP_TEMPLATES[template];
...
exports.STAKING_JACKPOT = { odds: [0, 0, 5000, 4000, 1000, 0, 0, 0, 0], winnersPerWeek: 10, soulboundDays: 7 };
exports.ANTI_FARM = {
...
// -----------------------------------------------------------------------------
function evOfOdds(odds) {
    return odds.reduce((acc, bps, i) => acc + (bps / 10_000) * (0, rarity_ts_1.profile)(i).valueMult, 0);
}
function freeValueReport(paidCommonsPerWeek, activeStakers = 5000) {
    const streakChipEv = evOfOdds(exports.DAILY_QUESTS[4].rewardChip.odds); // one per 7-day streak
    const weeklyChipEv = evOfOdds(exports.WEEKLY_QUESTS[4].rewardChip.odds);
    const jackpotEvPerWallet = (evOfOdds(exports.STAKING_JACKPOT.odds) * exports.STAKING_JACKPOT.winnersPerWeek) / activeStakers;
