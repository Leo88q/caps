...
exports.ARENA_ORACLE_DAILY_CAP_DEFAULT_CG = exports.BASELINE_ASSUMPTIONS = exports.SKR = exports.CURRENCY_BY_CODE = exports.CURRENCIES = exports.FEES = exports.SINKS = exports.EMISSION_SPLIT = exports.dailyEmission = exports.yearlyEmission = exports.playBucketTokens = exports.guardedEmission = exports.EMISSION_GUARD = exports.YEARLY_EMISSION_PCT_OF_PLAY = exports.ALLOCATION = exports.CG_HARD_CAP = exports.CG_DECIMALS = void 0;
exports.pvpDailyPotVolumeCg = pvpDailyPotVolumeCg;
exports.dailyFlows = dailyFlows;
exports.CG_DECIMALS = 6;
exports.CG_HARD_CAP = 1_000_000_000; // whole tokens
 ...
 */
exports.YEARLY_EMISSION_PCT_OF_PLAY = [18, 15, 12, 10, 8, 6, 5, 4];
/**
 ...
 */
exports.EMISSION_GUARD = { floorShare: 0.30, burnMultiple: 1.25 };
const guardedEmission = (scheduleCap, trailingDailyBurn) => Math.min(scheduleCap, exports.EMISSION_GUARD.floorShare * scheduleCap + exports.EMISSION_GUARD.burnMultiple * trailingDailyBurn);
exports.guardedEmission = guardedEmission;
const playBucketTokens = () => (exports.CG_HARD_CAP * 55) / 100;
exports.playBucketTokens = playBucketTokens;
const yearlyEmission = (year) => ((0, exports.playBucketTokens)() * (exports.YEARLY_EMISSION_PCT_OF_PLAY[year] ?? 0)) / 100;
exports.yearlyEmission = yearlyEmission;
const dailyEmission = (year) => (0, exports.yearlyEmission)(year) / 365;
exports.dailyEmission = dailyEmission;
/** How the daily emission is split between faucets (sum = 100). Admin-tunable within ±10pp without redeploy. */
exports.EMISSION_SPLIT = {
    chipStaking: 30,
    tokenStaking: 15,
    quests: 17,
...
exports.CURRENCY_BY_CODE = Object.fromEntries(exports.CURRENCIES.map((c) => [c.code, c]));
/**
...
function pvpDailyPotVolumeCg(a = exports.BASELINE_ASSUMPTIONS) {
 ...
 */
exports.ARENA_ORACLE_DAILY_CAP_DEFAULT_CG = pvpDailyPotVolumeCg();
/**
 ...
 */
function dailyFlows(a, year = 0) {
    const cap = (0, exports.dailyEmission)(year);
    ...
    const pvpRake = pvpDailyPotVolumeCg(a) * (exports.FEES.pvpRakeBps / 10_000);
    const mktFee = a.dau * a.marketplaceVolumeCgPerDauPerDay * (exports.FEES.marketplaceFeeBps / 10_000);
    let emission = cap;
    let burned = 0, toTreasury = 0, recycledPackSpend = 0;
    for (let i = 0; i < 8; i++) {
        const activeIncome = emission * (exports.EMISSION_SPLIT.quests + exports.EMISSION_SPLIT.pvpSeason + exports.EMISSION_SPLIT.eventsReserve) / 100;
        const stakerIncome = emission * (exports.EMISSION_SPLIT.chipStaking + exports.EMISSION_SPLIT.tokenStaking) / 100;
        ...
        const burnBps = exports.FEES.cgPackBurnBps / 10_000;
        const rakeBurnShare = 1 - (exports.FEES.pvpRakeTreasuryShareBps + exports.FEES.pvpRakePoolShareBps) / 10_000;
        const mktBurnShare = exports.FEES.marketplaceFeeBuybackShareBps / 10_000;
        burned = fusionBurn + packSpend * burnBps + pvpRake * rakeBurnShare + mktFee * mktBurnShare;
        toTreasury = packSpend * (1 - burnBps) + pvpRake * (exports.FEES.pvpRakeTreasuryShareBps / 10_000) + mktFee * (1 - mktBurnShare);
        emission = (0, exports.guardedEmission)(cap, burned);
    }
    return {
