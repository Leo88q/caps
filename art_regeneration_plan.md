# 🎯 План доведения арта до 100% (90/90) — регенерации, остатки, промты, форматы
...
### Район 09 «Inked Streets» / «Набитые Улицы» — 9 кадров (новых)
...
## 5. Пересдача 74 принятых кадров (контент утверждён → привести к формату мастера)
...
- [x] §3.1 `04-5` — реген-черновик выпущен (18-я партия, `art_drafts/master/04-5.png`)
- [x] §3.2 `05-5` — реген-черновик выпущен (18-я партия)
- [x] §3.3 `06-5` — реген-черновик выпущен (18-я партия)
- [x] `01-4` — черновик выпущен (v2; v1 отклонена на QA: маджентовые прутья внутри диска)
- [x] `07-2` — черновик выпущен (уровень на экране, по решению владельца)
- [ ] Подтверждение владельцем: 5 черновиков 18-й партии
- [ ] §4: осталось 14 кадров — район 09 целиком (9), район 10: тиры 2/3/4/5/7
- [ ] §5: пересдача 74 мастеров (после подтверждения черновиков)
- [ ] §6: 8 решений владельца
