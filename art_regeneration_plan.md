...
- [ ] Финальный QA: программные метрики сняты по каждому кадру (2048², Ø 87,5 %, альфа 0/255, тёмные лица — журналы партий в nft_tracker.md); осталось: визуальное подтверждение владельца, тест 130/56 px, экспорты пайплайна (game webp / nft / og — docs/07 §4)
